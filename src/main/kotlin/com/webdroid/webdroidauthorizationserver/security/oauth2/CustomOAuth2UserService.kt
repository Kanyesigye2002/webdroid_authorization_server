package com.webdroid.webdroidauthorizationserver.security.oauth2
...
import com.webdroid.webdroidauthorizationserver.security.oauth2.user.OAuth2UserInfo
import com.webdroid.webdroidauthorizationserver.security.oauth2.user.OAuth2UserInfoFactory
...
class CustomOAuth2UserService @Autowired constructor(
    ...
    private fun processOAuth2User(oAuth2UserRequest: OAuth2UserRequest, oAuth2User: OAuth2User): OAuth2User {
        ...
        val userOptional = userRepository.findByUsername(oAuth2UserInfo.email)
        var user: User
